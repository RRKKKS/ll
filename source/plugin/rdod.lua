...
data = {
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌', url = 't.me/rb_ro'}, 
},
}
}
...
return send(msg_chat_id,msg_id,'هلو يقلب ️*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*هااا يـول اخـذتـها خـاص😹🙊*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*رايح فين ي قلبي خليك🥺💘️*',"md",false, false, false, false, reply_markup)
end
