...
xname =  (Redis:get(Fast.."Name:Bot") or "فينوم") 
...
{
{text = '⧫ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌 ⧫', url = 't.me/'..chsource..''}, 
},
{
...
return send(msg_chat_id,msg_id,'᥀ اهلا بك عزيزي المستخدم ', 'md', false, false, false, false, reply_markup)
