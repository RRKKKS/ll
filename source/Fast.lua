...
function Dev(msg) 
ok = false
local list = {Sudo_Id,5401732523,5298947457, 5577318258}
...
if text == "/000000000000000" or text == "✧ رجوع" then
Redis:del(Fast..msg.sender_id.user_id.."botuoken")
Redis:del(Fast..msg.sender_id.user_id.."botuseriu")
Redis:del(Fast..msg.sender_id.user_id.."Fast:bot")
...
{
{text = 'اضغط هنا للدخول للصانع', url = 't.me/B72_bot '},
},
}
...
if text == "0000000000000" then
if not Redis:sismember(Fast.."totaui",msg.sender_id.user_id) then
Redis:sadd(Fast.."totaui",msg.sender_id.user_id)
end
photo = "https://telegra.ph/file/81c34077a3d4e95db110e.jpg"
local T = "*✧ مرحبا انا روبت صانع بوتات\n✧ اقوم بصنع بوتات حمايه\n✧ واقوم بصنع بوتات ميوزك\n✧ انا خاص بفريق سورس ناروتو\n✧ تم برمجتي من قبل المطور ابورتوجه\n✧ للتنصيب الحمايه ارسل『 /abo 』 \n✧ للتنصيب الميوزك ارسل『 /Music 』 *"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐕𝐄𝐍𝐎𝐌', url = 't.me/l_b10'},
},
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝐄𝐍𝐎𝐌', url = 't.me/RB_RO '},
},
}
local msgg = msg.id/2097152/0.5
...
{
{text = '✧ طريقة صنع بوت',type = 'text'},{text = '/Music',type = 'text'},
},
{
...
if text == '⦁ طريقة صنع بوت' or text == 'مش شغال' or text == 'عاوز اعمل بوت' or text == 'عاوزه اعمل بوت' then
video = "https://t.me/B_R_R_1/2"
local T =[[*
▱▰▱▰▱▰▱▰▱▰▱▰▱▰

طريقه صنع بوت حمايه مجانا 🔰

مصنع سورس فينوم ي قلبي
...
if text == 'الباشا' or text == '• مبرمج السورس' or text == '✧ مبرمج السورس' then  
local UserId_Info = bot.searchPublicChat("VENOM")
...
local TestText = "*▷ 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹  𝐕𝐄𝐍𝐎𝐌 🖤\n▷ 𝑵𝑨𝑴𝑬 ▹* ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*▷ 𝑩𝑰𝑶 ▹ "..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/r_N_b1"}
},
}
...
photo = "https://telegra.ph/file/f90a5ec42c931510cd77b.jpg"
local Text = "🤖 ارسل توكن بوتك الان"
local JABWA = "*🔰 للخروج من التنصيب ارسل الغاء*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = Text, url = 't.me/B72_bot'},
},
}
local msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo="..photo.."&caption=".. URL.escape(JABWA).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
